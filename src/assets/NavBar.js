        ...
        <Navbar.Toggle aria-controls="basic-navbar-nav" />
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="m-auto">
              ...
              <Icon.House y color="white" size="20"/>Home</Nav.Link>
              <Nav.Link href="http://localhost:3000/FunctionsChoice/0x3f60320F7479B7aB8ba5ec87C5b116A5068a8f4f" className ="text-white text-uppercase ml-5">Function Choice</Nav.Link>
              <DropDown/>
          </Nav>
          <Form inline>
