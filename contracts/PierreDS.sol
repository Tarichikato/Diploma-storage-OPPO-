...
contract DiplomaStorage {
    ...
    function createDegree(uint _year, string memory _nameDegree) public {
        // si le diplome n'existe pas
            degreeCount ++;
            degrees[degreeCount] = Degree(degreeCount, _year,_nameDegree);
            emit DegreeCreated(degreeCount,_year,_nameDegree);
        //sinon erreur
    }
